...
PYBIND11_MODULE(triangulumancer, m, pybind11::mod_gil_not_used(),
  ...
  pybind11::class_<PointConfiguration>(m, "PointConfiguration")
      ...
      .def_property_readonly("n_points", &PointConfiguration::n_points)
      .def_property_readonly("dim", &PointConfiguration::dim)
  ...
  pybind11::class_<VectorConfiguration>(m, "VectorConfiguration")
      .def(pybind11::init<>())
      .def(pybind11::init<pybind11::array_t<int> const &>())
      .def_property_readonly("n_vectors", &VectorConfiguration::n_vectors)
      .def_property_readonly("dim", &VectorConfiguration::dim)
  ...
  pybind11::class_<Triangulation>(m, "Triangulation")
      ...
      .def_property_readonly("n_simplices", &Triangulation::n_simplices)
