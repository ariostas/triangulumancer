...
namespace triangulumancer {
  ...
  Triangulation triangulate_cgal(PointConfiguration &pc, std::vector<double> &params, TriangParamType param_type = TriangParamType::Heights)
  {
  ...
  Triangulation triangulate_delaunay(PointConfiguration pc) {
    ...
    switch (pc.dim()) {
      case 1:
        return triangulate_cgal<CGAL::Dimension_tag<1>>(pc, weights, TriangParamType::Weights);
      case 2:
        return triangulate_cgal<CGAL::Dimension_tag<2>>(pc, weights, TriangParamType::Weights);
      case 3:
        return triangulate_cgal<CGAL::Dimension_tag<3>>(pc, weights, TriangParamType::Weights);
      case 4:
        return triangulate_cgal<CGAL::Dimension_tag<4>>(pc, weights, TriangParamType::Weights);
      case 5:
        return triangulate_cgal<CGAL::Dimension_tag<5>>(pc, weights, TriangParamType::Weights);
      case 6:
        return triangulate_cgal<CGAL::Dimension_tag<6>>(pc, weights, TriangParamType::Weights);
      case 7:
        return triangulate_cgal<CGAL::Dimension_tag<7>>(pc, weights, TriangParamType::Weights);
      case 8:
        return triangulate_cgal<CGAL::Dimension_tag<8>>(pc, weights, TriangParamType::Weights);
      case 9:
        return triangulate_cgal<CGAL::Dimension_tag<9>>(pc, weights, TriangParamType::Weights);
      case 10:
        return triangulate_cgal<CGAL::Dimension_tag<10>>(pc, weights, TriangParamType::Weights);
      default:
        return triangulate_cgal<CGAL::Dynamic_dimension_tag>(pc, weights, TriangParamType::Weights);
    }
  }
