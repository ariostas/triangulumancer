...
Triangulation triangulate_fine(triangulumancer::VectorConfiguration const &pc);
...
std::vector<Triangulation>
find_all_connected_triangulations(VectorConfiguration const &pc,
                                  bool only_fine = false);


std::vector<Triangulation> find_all_triangulations(PointConfiguration const &pc,
                                                   bool only_fine = false);
std::vector<Triangulation> find_all_triangulations(VectorConfiguration const &pc,
                                                   bool only_fine = false);
